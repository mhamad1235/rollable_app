...
function HotelDashboard() {
  ...
  if (loading) {
    return <div className="dashboard-container">Loading rooms...</div>;
  }
      ...
      <div className="activity-section">
        ...
        <div className="activity-grid">
          <div className="activity-item">
            <p className="blue">Arrival Today</p>
            <span>13</span>
          </div>
          <div className="activity-item">
            <p className="green">Departure Today</p>
            <span>13</span>
          </div>
          <div className="activity-item">
            <p className="orange">Walk-ins Today</p>
            <span>13</span>
          </div>
          <div className="activity-item">
            <p className="red">Cancellation</p>
            <span>13</span>
          </div>
        </div>
      </div>
